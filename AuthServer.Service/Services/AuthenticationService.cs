...
namespace AuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<Response<NoDataDto>> RevokeRefresTokenAsync(string refresToken)
        {
            var existRefreshToken = await _userRefreshTokenService.Where(x => x.Code == refresToken).SingleOrDefaultAsync();
